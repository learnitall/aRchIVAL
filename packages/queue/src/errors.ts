 ...
 */
export const ErrorNameQueueConnect = "ErrorQueueConnect";
export const ErrorNameMessageMustBeJson = "ErrorMessageMustBeJson";
export const ErrorNameSendFailure = "ErrorSendFailure";
export const ErrorNameReceiveFailure = "ErrorReceiveFailure";
